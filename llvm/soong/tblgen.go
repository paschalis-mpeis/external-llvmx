...
//func init() {
//    //android.RegisterModuleType("xllvm_tblgen", llvmTblgenFactory)
//}

//var (
//	pctx = android.NewPackageContext("android/soong/llvmx")

//	llvmTblgen = pctx.HostBinToolVariable("llvmTblgen", "xllvm-tblgen")
...
//	includes := []string{
//		"-I " + ctx.ModuleDir(),
//		"-I external/llvmx/include",
//		"-I external/llvmx/lib/Target",
...
//    log.Print("outToGenerator: s: " + out)
//	switch {
...
//    // case out == "ARMGenSystemRegister.inc":
//        // return  "-gen-searchable-tables"
